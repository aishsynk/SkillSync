...
| `AllocationApi` | Not yet extracted — reserved for its own independent increment (D) per explicit instruction, given its sensitivity relative to Trainer/Batch |
