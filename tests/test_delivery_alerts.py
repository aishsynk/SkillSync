...
class DeliveryAlertsTests(unittest.TestCase):
    def test_recording_gap_and_pax_drop(self):
        ...
        pax = next(a for a in alerts if a["kind"] == "pax_drop")
        self.assertEqual("high", pax["severity"])  # 8 of 10 dropped
